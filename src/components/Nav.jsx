   ...
   <div className="logo">
    ...
    <ul className='social flex items-center gap-[30px] w-[25%]'>
        <li>
            ...
            <img src="\icons8-whatsapp-100.png" alt=""className='h-[60px] ' />9708902003</a></li>
        <li>
            <a href="https://www.instagram.com/bshivaonline?igsh=andwcDl1ajhpbDUy" className='text-white' target='blank'>
            <img src="\icons8-instagram-500.png" alt="" className='h-[60px] ' />Instagram</a></li>
        <li>
            <a href="https://t.me/+n44kyspP8KlmNDc1" target='blank' className='text-white'>
            <img src="\icons8-telegram-100.png" alt="" className='h-[60px]' />Telegram</a></li>
    </ul>
    </div>
   </>
  )
